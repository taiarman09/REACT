      ...
      <div className="flex flex-col py-3 lg:flex-row gap-5">
        ...
        <div className="w-full lg:w-[70%]">
          ...
          <div className="relative group">
            <img
              className="w-full h-[300px] sm:h-[400px] lg:h-[550px] rounded-xl object-cover"
              src={megasale}
              alt=""
            />
                    ...
                    <div className="mt-2 sm:mt-3">
...

                      {
                        users ? (
                          ...
                          <button className="mt-2 sm:mt-3 w-full py-1.5 sm:py-2 text-sm sm:text-base bg-blue-900 text-white rounded-md hover:bg-blue-700 transition">
                            Add To Cart
                          </button>
                        )
                      }
